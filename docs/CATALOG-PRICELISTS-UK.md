...
**Етап 4 — редизайн (візуальний і UX).** Робоча назва сайту — «ТеплоКабель» (логотип пізніше). Світлий фон,
палітра як «збірна» з сайтів постачальників (Hemstedt, Fenix, Nexans, Magnum, Easytherm, Ryxon…): один теплий
акцент (помаранчевий/червоний «тепло»), один холодний (синій/графіт «техніка»), нейтральні світлі поверхні.
Структура: головна (розділи каталогу з фото, підбір за застосуванням, бренди, переваги, контакти), розділ
(фільтри-мітки зліва або зверху, картки з фото, ціною й ключовими характеристиками), картка товару
(галерея, ціна/комплект, характеристики таблицею, мітки, схожі товари), сторінка бренду, «Про нас»/контакти.
Мета — показувати сайт замовникам і партнерам уже на цьому етапі.
