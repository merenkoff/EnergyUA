...
> **Архів.** Цей імпорт описує старий каталог з донорів. З вересня 2026 такі товари записуються з `archived = true` і на сайті не показуються, а їхні категорії лежать під коренем «Архів». Актуальний каталог будується з прайсів постачальників — див. [`CATALOG-PRICELISTS-UK.md`](CATALOG-PRICELISTS-UK.md).
